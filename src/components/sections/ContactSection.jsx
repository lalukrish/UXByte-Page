      ...
      <div className="mt-[-120]">
        <div className="grid grid-cols-5 gap-10 mt-40 ml-10">
          ...
          <div className="col-span-3">
            <div
              className="max-w-2xl p-16 bg-gray-600   rounded-lg shadow  dark:bg-gray-800 "
              style={{ borderRadius: "25px", backgroundColor: "#3f3f3f" }}
            >
              <div>
              ...
              <div className="flex gap-2">
                <button
                  ...
                  className="hover:bg-white hover:text-black focus:ring-4 focus:outline-none focus:ring-white-300 rounded-lg text-xs sm:text-sm px-2 py-1 sm:px-4 sm:py-2 text-center dark:bg-gray-600 dark:hover:bg-white dark:focus:ring-white dark:hover:text-black"
                >
                  UI UX Design
                </button>
                <button
                  ...
                  className="hover:bg-white-800 focus:ring-4 focus:outline-none focus:ring-white-300 rounded-lg text-xs sm:text-sm px-2 py-1 sm:px-4 sm:py-2 text-center dark:bg-gray-600 dark:hover:bg-white dark:focus:ring-white"
                >
                  Web Tech
                </button>
                <button
                ...
                <div className="grid gap-6 mb-6 md:grid-cols-2">
                  ...
                  <div>
                    ...
                    <input
                      type="text"
                      id="first_name"
                      className="border border-white text-white text-sm rounded-lg block w-full p-2.5 dark:border-white dark:placeholder-gray-400 dark:text-white "
                  ...
                  <div>
                    ...
                    <input
                      type="text"
                      id="last_name"
                      className="bg-gray-50 border border-gray-300 text-white text-sm rounded-lg   block w-full p-2.5 dark:border-white dark:placeholder-gray-400 dark:text-white "
                      style={{ backgroundColor: "#3f3f3f3f" }}
                      placeholder=""
                      required
                    />
                  ...
                  <div className="">
                    ...
                    <textarea
                      id="message"
                      rows="3"
                      className="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300   dark:border-white dark:placeholder-gray-400 dark:text-white "
                      style={{ backgroundColor: "#3f3f3f3f" }}
                      placeholder=""
                    ></textarea>
                  </div>
