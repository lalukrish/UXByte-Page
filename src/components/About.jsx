...
const About = ({ theme, toggleTheme }) => {
  ...
  return (
    ...
    // </div>
    <div className="p-20">
      <h2 className="font-bold text-4xl bg-gray-950">We are an international creative agency merging design proficiency with advanced technology and strategic insight.</h2>
    </div>
  );
};
